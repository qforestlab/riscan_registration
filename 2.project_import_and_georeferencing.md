...
**4.b Import .PROJ**
> The following is an alternative method for importing scanner projects (following version 2.22 related errors).
1. Go to your file explorer and drag the .PROJ file and drop it into the empty RiSCAN PRO project.
<br><br>
![alt text](img/import_scanner_project_window.png)
2. *"Continue in one-touch processing wizard..."*
3. *Settings*
<br><br>
![alt text](img/onetouchprocessingwizard_import.png)
4. *Integrate and check the boxes → Close settings → Start*
