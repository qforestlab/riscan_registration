...
<br>![alt text](img/fix4.png)
<br>![alt text](img/fix5.png)
3. *Extract plane patches for both scans now. Select them, right click → Extract plane patches*
<br>![alt text](img/fix6.png)
<br>![alt text](img/fix7.png)
...
<br>![alt text](img/fix9.png)
<br>![alt text](img/fix10.png)
