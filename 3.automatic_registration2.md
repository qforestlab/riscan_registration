...
You can use [this online tool](https://mone27.github.io/tls-rotation-tools/tools/voici/render/up2tilt.html) to get an estimate of the scan position from a up to a tilt position (or the opposite from a tilt to an up)

Alternatively you can follow the steps below to manually estimate this position.
